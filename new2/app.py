...
class Question(Fact):
    def __init__(self, ident=None, questionType=None, valid=None, text=None, cfq=None, qid=None):
        super().__init__()
        self.id = qid  # Unique ID for each question
        self.ident = ident
...
class SkinCareExpertSystem(KnowledgeEngine):
    ...
    def _initial_action(self):
        questions_data = [
            {"ident": "Skin Type", "questionType": "multi", "valid": ["dry", "oily", "normal", "combination"],
             "text": "What is your skin type ?", "cfq": "What is your cf?"},
            {"ident": "SkinTone", "questionType": "multi", "valid": ["fair", "medium", "dark"],
             "text": "What is your skin tone ?", "cfq": "What is your cf?"},
            {"ident": "Gender", "questionType": "multi", "valid": ["female", "male"],
             "text": "What is your gender sir/mam?", "cfq": "What is your cf?"},
            {"ident": "pregnancy", "questionType": "multi", "valid": ["yes", "no"],
             "text": "Are you pregnant or currently breastfeeding", "cfq": "What is your cf?"},
            {"ident": "Acne", "questionType": "multi", "valid": ["yes", "no"],
             "text": "Do you happen to have acne ?", "cfq": "What is your cf?"},
            {"ident": "Age", "questionType": "multi", "valid": ["young", "adult", "mature"],
             "text": "How old are you?", "cfq": "What is your cf?"},
            {"ident": "season", "questionType": "multi", "valid": ["summer", "winter", "spring", "autumn"],
             "text": "What is the current season in your location?", "cfq": "What is your cf?"},
            {"ident": "routine", "questionType": "multi", "valid": ["morning", "night", "both"],
             "text": "What type of routine are you looking for?", "cfq": "What is your cf?"},
            {"ident": "sensitvity", "questionType": "multi", "valid": ["yes", "no"],
             "text": "Do you consider your skin to be sensitive?", "cfq": "What is your cf?"},
            {"ident": "sensitvity details", "questionType": "multi",
             "valid": ["Not any", "allergy to salicylic acid", "Fragrance Allergy", "Food", "Chemicals", "Preservative"],
             "text": "Provide sensitivity details?", "cfq": "What is your cf?"},
            {"ident": "skin condition", "questionType": "multi",
             "valid": ["Not any", "Rosacea", "Eczema", "Perioral Dermatitis", "Periorific Dermatitis",
                       "Seborrheic Dermatitis (scalp)", "Seborrheic Dermatitis (face)"],
             "text": "Do you have any of these skin conditions?", "cfq": "What is your cf?"},
            {"ident": "acne details", "questionType": "multi", "valid": ["Not any", "moderate", "severe"],
             "text": "How bad is your acne?", "cfq": "What is your cf?"},
            {"ident": "skin defects", "questionType": "multi", "valid": ["yes", "no"],
             "text": "Do you have any skin defects?", "cfq": "What is your cf?"},
            {"ident": "skin defects details", "questionType": "multi", "valid": ["Not any", "yes", "no"],
             "text": "Do you have any skin defect details?", "cfq": "What is your cf?"}
        ]

        # Generate questions and assign IDs
        for idx, q_data in enumerate(questions_data):
            yield Question(
                ...
                text=q_data["text"],
                cfq=q_data["cfq"],
                qid=idx + 1  # Assigning IDs starting from 1
            )

    def get_next_question(self):
        # Determine the next question to ask based on the current state
        for question in self.questions:
            if not self.is_question_answered(question.id):
                return question
        return None  # Return None if all questions have been answered

    def is_question_answered(self, question_id):
        # Check if a question with the given ID has been answered
        for fact in self.facts:
            if isinstance(fact, Answer) and fact.ident == question_id:
                return True
        return False
...
def render_question():
    # Fetch the next question to ask from the expert system
...
def answer():
    ...
    # Assert the user's answer into the expert system
    engine.assert_answer(answer, cf)

    # Continue asking questions until finished or return recommendations
    if engine.is_questioning():
        return render_question()
    else:
