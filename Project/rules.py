# -*- coding: utf-8 -*-
# from experta import Rule, Fact, MATCH, NOT, AS, L
from experta import *
from facts import Answer, Question, Ask, User, Recommendations
from engine import *


class SkinCareRules(SkinCareExpertSystem):

    # This is to ask questions (from lab)
    ...
    def ask_question_by_ident(self, ask, id, text, valid, questionType, cfq):
        ...
        self.retract(ask)
        # take the answer from the user using the helper function which we have created earlier
